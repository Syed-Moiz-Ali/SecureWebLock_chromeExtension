...
//   console.log(`currentWebsite is ${currentWebsite}`);
  const extensionStoredPassword = sessionStorage.getItem('extensionStoredPassword');
//   console.log(`extensionStoredPassword is ${extensionStoredPassword}`)
  if (extensionStoredPassword !== null) {
    ...
    if (restrictedWebsites.some(website => currentWebsite.includes(new URL(website).hostname))) {
        ...
        .then(html => {
            ...
            cancelButton.addEventListener('click', function () {
                ...
                const customPasswordPopup = document.getElementById('popupContainer');
                ...
                chrome.storage.sync.get(['extensionPassword'], function (result) {
                    ...
                    if (storedPassword !== undefined) {
                        ...
                        if (enteredCustomPassword === storedPassword) {
                            ...
                            const customPasswordPopup = document.getElementById('popupContainer');
                            const backgroundContainerId = document.getElementById('backgroundContainer');
                            if (customPasswordPopup) {
                                document.body.removeChild(customPasswordPopup);
